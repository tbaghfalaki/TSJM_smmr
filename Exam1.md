...
Note that since the purpose of the Moreno-Betancur et al. (2018) approach is parameter estimation, and the available R package survtd only performs parameter estimation, we exclude the MB approach from this comparison. To implement this approach for the generated data, refer to https://github.com/tbaghfalaki/TSJM_smmr/blob/main/Exam2.md.
